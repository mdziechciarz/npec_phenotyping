...
def init():
    ...
    # Show the files in the base_path directory
    print("List of files in the base_path directory:")
    list_files(base_path)

    # Construct the model path
    model_path = os.path.join(base_path, 'INPUT_model_path')  # Assuming your model is directly under this path
